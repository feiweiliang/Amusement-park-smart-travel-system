...
<template>
  <div class="wrapper">
    ...
    <el-main>
      ...
      <!-- 这里是关键，实际上左侧的二级菜单栏要做好几个，单纯做一个不够的，一级菜单栏有几个项目，二级菜单就得对应几个 -->
    </el-main>
...
export default {
  data(){
    return{
      itemList: [    // 水平一级菜单栏的菜单
        { path: '/Home', title: '首页' },
        { path: '/content1', title: '园区状况' },
        { path: '/content2', title: '出行建议' },
        { path: '/content3', title: '排队管理' },
          { path: '/content4', title: '我的出行' },
