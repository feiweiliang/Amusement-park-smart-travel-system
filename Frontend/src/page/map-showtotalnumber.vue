<template>
    ...
    <div id="app" class="flex-row" style="overflow:auto;height: 1010px;width:1010px;margin: auto;">
        <div class="pr area-wrap oh" >
            ...
            <div class="layer mapFloat">
                <template v-if="!item.block" v-for="(item,index) in polygons">
                    <span :key="'float'+index" class="_title" :style="{left:item.attrDataX+'px', top:item.attrDataY+'px'}">{{item.attrTitle}}<br/><font color="red">当前人数:{{item.num}}</font></span>
                </template>
            </div>
            <!-- 路径绘制层（这个功能用于绘制路径） -->
        ...
        <div class="flex-1" style="margin:50px;display: none;">
        <el-row :gutter="8">
            <el-col :span="8">
...
<!-- 地图编辑面板 （显示地图中项目的名称）-->
            <mapediter :polygon="currentPolygon"/>
    ...
    export default {
        ...
        data() {
            return {
                ...
                nums:[{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""},{"attrTitle": "","num": ""}]
            };
        },
        watch: {
        ...
        methods: {
            ...
            get_num: function(){
                // 可以在这个地方向后端请求数据http://127.0.0.1:8181/user/getPlacesUsersNumber
               instance.get('http://127.0.0.1:8181/user/getPlacesUsersNumber').then(res => {

                     //console.log('it works');
                    this.nums = res.data.data;
                    for (var i=0,len=this.polygons.length; i<len; i++)
                        {  
                            //console.log('it works i=',i);
                            //console.log('it works,nums[i]',this.nums[i]['num']);
                            this.polygons[i]['num']=this.nums[i]['num'];
                            //this.polygons[i]['num']="110"
                        }
                        this.resetSvg();
                        console.log("num22:",this.polygons[3]['num'])
                      // location.reload();
                });
            },
            useTest: function () {
                ...
                // 这是导入地图的方式
                // instance.get('http://127.0.0.1:8181/map/getMap').then(res => {
                //     this.importMap(res.data.data)
                // })
                // 导入路径的方式
                instance.get('http://127.0.0.1:8181/path/getRoutePlan/830/星际飞碟').then(res => {
                    //this.importPath(res.data.data)
                })
        ...
        mounted: function () {
            ...
            this.useTest();
            //this.resetSvg();
            console.log("num&&",this.polygons[3]['num'])
        }
    };
